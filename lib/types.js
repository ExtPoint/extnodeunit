        ...
        mockFunction: function(name) {
            ...
            return function() {
                ...
                if (myExpectedCalls.length == 0) {
                    this.fail('Calling "' + name + '" function more times, than expected. Call #' + callNumber);
                }
                expectedCalls--;
                ...
                this.equal(arguments.length, expectedArguments.length,
                    'Wrong "' + name + '" function argument count. Expected ' + expectedArguments.length + 'got ' +
                    arguments.length + ', call #' + callNumber
                );
                for (var i = 0; i < arguments.length; i++) {
                    this.deepEqual(arguments[i], expectedArguments[i],
                        'Wrong "' + name + '" function argument #' + i + ' value. Expected "' + expectedArguments[i] + '" got "' +
